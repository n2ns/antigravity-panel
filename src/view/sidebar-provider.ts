    ...
    private _updateHtml(): void {
        ...
        this._view.webview.html = new WebviewHtmlBuilder()
            ...
            .setTranslations({
                ...
                weeklyUsage: vscode.l10n.t('Weekly Usage'),
                weeklyUsageTooltip: vscode.l10n.t('Local 7-day estimate: percentage points of the short-term quota pool consumed. Not the official weekly limit.'),
                noSamplingData: vscode.l10n.t('No sampling data (IDE was closed)'),
                last7Days: vscode.l10n.t('Last 7 days'),
                previous7Days: vscode.l10n.t('Previous 7 days'),
                noPreviousWeekData: vscode.l10n.t('No previous-week data'),
